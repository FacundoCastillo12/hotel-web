...
function Room({ room }) {
  const { id, title, roomImg, details, priceForDay } = room;
  const priceForAWeek = priceForDay * 7;
  return (
    <div className="mt-2 w-full max-w-[26rem] rounded-lg border-2 border-slate-200 bg-white shadow-lg hover:scale-105">
